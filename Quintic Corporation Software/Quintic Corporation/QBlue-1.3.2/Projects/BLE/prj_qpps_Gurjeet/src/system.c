...
static void SystemIOCfg(void)
{
    ...
    syscon_SetPMCR0(QN_SYSCON, P00_UART0_TXD_PIN_CTRL
                             ...
                             | P14_GPIO_12_PIN_CTRL // mux control 1
                             | P15_GPIO_13_PIN_CTRL // mux control 2
    ...
    syscon_SetPMCR1(QN_SYSCON, P20_GPIO_16_PIN_CTRL
                             ...
                             | P23_I2C_SDA_PIN_CTRL //I2C
                             | P24_I2C_SCL_PIN_CTRL //I2C
                             | P25_GPIO_21_PIN_CTRL
                             | P26_GPIO_22_PIN_CTRL
                             | P27_GPIO_23_PIN_CTRL

                             | P30_AIN0_PIN_CTRL //ADC in 1
                             | P31_AIN1_PIN_CTRL //ADC in 2
                             ...
                             | P35_GPIO_29_PIN_CTRL   //(Acclelromter interrupt)           
#endif
