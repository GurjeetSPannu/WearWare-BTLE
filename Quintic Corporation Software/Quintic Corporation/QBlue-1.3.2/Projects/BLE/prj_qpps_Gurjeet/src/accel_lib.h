...
#define ACCEL_INT_PIN 					GPIO_P03 //GPIO_P04

#define EVENT_ACCEL_INT_ID 			12

#define ACCEL_FIFO_DEPTH 				28 // set to 28 originally

#define ACCEL_X										0x01
#define ACCEL_Y										0x02
#define ACCEL_XY									0x03
#define ACCEL_Z										0x04
#define ACCEL_XZ									0x05
#define ACCEL_YZ									0x06
#define ACCEL_XYZ									0x07
