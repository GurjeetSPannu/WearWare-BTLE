...
enum
{
    ...
    BAS_IDX_BATT_LVL_PRES_FMT,
	  ...
	  // ADDED BY JOE
	  BAS_IDX_TEMP_LVL_CHAR,
    BAS_IDX_TEMP_LVL_VAL,
    BAS_IDX_TEMP_LVL_NTF_CFG,
    BAS_IDX_TEMP_LVL_PRES_FMT,
...
//ADDED BY JOE
///Battery Level Service Temperature Level Characteristic
extern const struct atts_char_desc bas_temp_level_char;
